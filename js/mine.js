...
$(".strip-toggel-menu").click(function () {
    isTrue ? ($(".nav-tab-menu").addClass("open-menu").removeClass("close-menu"), nvWidth = $(".nav-tab-menu").width() - 10, $(".strip-header-nav").css("left", nvWidth), $(".fa-align-justify").toggleClass("fa-times"), $(".nav-tab-menu .item1").animate({
        opacity: "1",
        paddingTop: "25px"},1100),
        $(".nav-tab-menu .item2").animate({
        opacity: "1",
        paddingTop: "25px"}, 1200),
        $(".nav-tab-menu .item3").animate({
        opacity: "1",
        paddingTop: "25px"}, 1300), 
        $(".nav-tab-menu .item4").animate({
        opacity: "1",
        paddingTop: "25px"}, 1400), 
        $(".nav-tab-menu .item5").animate({
        opacity: "1",
        paddingTop: "25px"}, 1500), 
        $(".nav-tab-menu .item6").animate({
        opacity: "1",
        paddingTop: "25px"}, 1600), 
        isTrue = !isTrue) : ($(".nav-tab-menu").addClass("close-menu").removeClass("open-menu"), $(".fa-align-justify").toggleClass("fa-times"), $(".strip-header-nav").css("left", 0), $(".nav-tab-menu li").animate({
        opacity: "0",
        paddingTop: "500px"}, 500), 
        isTrue = !isTrue)
});
let isSearchTrue = !0;
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<input class="form-control shadow pt-3" onkeyup="validation()" id="name"
				...
				<div class="col-md-6">
					<div class="form-group">
						<input onkeyup="validation()" class="form-control pt-3" id="email" placeholder="Enter Email">
				...
				<div class="col-md-6">
					<div class="form-group">
						<input onkeyup="validation()" class="form-control pt-3" id="phone" placeholder="Enter phone">
				...
				<div class="col-md-6">
					<div class="form-group">
						<input onkeyup="validation()" class="form-control pt-3" id="age" placeholder="Enter Age">
				...
				<div class="col-md-6">
					<div class="form-group">
						<input onkeyup="validation()" class="form-control pt-3" type="password" id="password"
				...
				<div class="col-md-6">
					<div class="form-group">
						<input onkeyup="validation()" class="form-control pt-3" type="password" id="rePassword"
